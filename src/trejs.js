...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__Z11check_errori')) {
        Object.defineProperty(Module['ready'], '__Z11check_errori', { configurable: true, get: function() { abort('You are getting __Z11check_errori on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__Z11check_errori', { configurable: true, set: function() { abort('You are setting __Z11check_errori on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__Z8findall_PcS_')) {
        Object.defineProperty(Module['ready'], '__Z8findall_PcS_', { configurable: true, get: function() { abort('You are getting __Z8findall_PcS_ on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__Z8findall_PcS_', { configurable: true, set: function() { abort('You are setting __Z8findall_PcS_ on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_findall')) {
        Object.defineProperty(Module['ready'], '_findall', { configurable: true, get: function() { abort('You are getting _findall on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_findall', { configurable: true, set: function() { abort('You are setting _findall on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var __Z11check_errori = Module["__Z11check_errori"] = createExportWrapper("_Z11check_errori");

/** @type {function(...*):?} */
var __Z8findall_PcS_ = Module["__Z8findall_PcS_"] = createExportWrapper("_Z8findall_PcS_");

/** @type {function(...*):?} */
var _findall = Module["_findall"] = createExportWrapper("findall");
